...
4. Validate: against T18's partial-coverage subset if one exists, else hand-validate a
...
logged in `RESULTS.md`; link-rate over the T17 restructure population reported; if
